...
kevin_root_dir="/c0/home/koo/src/koofs"
log_path="/log/filebench_vm2vmlog-$(date +'%Y%m%d-%H%M%S')"
...
do_ext4() {
    ...
    do
        ...
        ${kevin_root_dir}/real/setup_cheeze_vm2vm.sh
        echo "Please run:"
        echo "cd /home/kukania/Koofs_proj/FlashFTLDriver/; ./cheeze_block_driver > /c0pt2/$output_file_kukania"
        # ssh root@pt1 "cd /home/kukania/Koofs_proj/FlashFTLDriver/; ./cheeze_block_driver > /c0pt2/$output_file_kukania 2>&1 < /dev/null" &
